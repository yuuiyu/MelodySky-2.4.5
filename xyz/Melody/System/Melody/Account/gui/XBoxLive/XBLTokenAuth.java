...
public class XBLTokenAuth extends GuiScreen
{
    ...
    public XBLTokenAuth(final GuiScreen previousScreen) {
    ...
    private String getAccessToken(final String xstsToken, final String uhs) throws IOException {
        ...
        final URL url = new URL("https://127.0.0.1/login_with_xbox");
    ...
    public String[] getXSTSTokenAndUserHash(final String xboxLiveToken) throws IOException {
        ...
        final URL ConnectUrl = new URL("https://127.0.0.1");
        ...
        xbl_param.addProperty("RelyingParty", "rp://127.0.0.1");
