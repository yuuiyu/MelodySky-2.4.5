...
public class AddTokenAuthGui extends GuiScreen
{
    ...
    public AddTokenAuthGui(final GuiScreen previousScreen) {
        this.status = "Session:";
    ...
    protected void actionPerformed(final GuiButton button) throws IOException {
        if (button.id == 997) {
            try {
                ...
                Client.instance.getAccountManager().addAlt((Alt)new OriginalAlt(username, token, uuid, "mojang"));
