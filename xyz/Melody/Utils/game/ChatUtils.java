    ...
    public static class ChatMessageBuilder
    {
        ...
        public ChatMessageBuilder(final boolean prependDefaultPrefix, final boolean useDefaultMessageColor) {
            ...
            if (prependDefaultPrefix) {
                this.theMessage.appendSibling((IChatComponent)new ChatMessageBuilder(false, false).appendText(String.valueOf(EnumChatFormatting.AQUA + "Melody > ")).setColor(EnumChatFormatting.RED).build().getChatComponent());
            }
