...
public class ColorUtils
{
    ...
    public static Color getArmorColor(final float armor, final float maxArmor) {
        final float[] fractions = { 0.0f, 0.33f, 0.66f, 1.0f };
        final Color[] colors = { new Color(Colors.DARKGREY.c), new Color(Colors.GRAY.c), new Color(Colors.DARKBLUE.c), new Color(Colors.BLUE.c) };
        final float progress = armor / maxArmor;
        return blendColors(fractions, colors, progress).brighter();
    }
