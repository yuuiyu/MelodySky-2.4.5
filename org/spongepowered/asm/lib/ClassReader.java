        ...
        if (av != null) {
            Label_1221: {
                switch (this.b[v++] & 0xFF) {
                    ...
                    case 66: {
                        av.visit(name, (Object)new Byte((byte)this.readInt(this.items[this.readUnsignedShort(v)])));
                        v += 2;
                        break;
                    }
                    case 90: {
                    ...
                    case 83: {
                        av.visit(name, (Object)new Short((short)this.readInt(this.items[this.readUnsignedShort(v)])));
                        v += 2;
                        break;
                    }
                    case 67: {
                        av.visit(name, (Object)new Character((char)this.readInt(this.items[this.readUnsignedShort(v)])));
                        v += 2;
                        break;
                    }
                    case 115: {
