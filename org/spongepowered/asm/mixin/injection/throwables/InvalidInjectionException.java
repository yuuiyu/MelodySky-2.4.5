...
public class InvalidInjectionException extends InvalidMixinException
{
    ...
    public InvalidInjectionException(final IReferenceMapperContext context, final String message) {
    ...
    public InvalidInjectionException(final IReferenceMapperContext context, final Throwable cause) {
        super(context, cause);
        this.info = null;
    }
    ...
    public InvalidInjectionException(final IReferenceMapperContext context, final String message, final Throwable cause) {
