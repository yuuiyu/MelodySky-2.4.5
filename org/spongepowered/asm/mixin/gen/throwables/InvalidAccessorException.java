...
public class InvalidAccessorException extends InvalidMixinException
{
    ...
    public InvalidAccessorException(final IReferenceMapperContext context, final String message) {
    ...
    public InvalidAccessorException(final IReferenceMapperContext context, final Throwable cause) {
        super(context, cause);
        this.info = null;
    }
    ...
    public InvalidAccessorException(final IReferenceMapperContext context, final String message, final Throwable cause) {
