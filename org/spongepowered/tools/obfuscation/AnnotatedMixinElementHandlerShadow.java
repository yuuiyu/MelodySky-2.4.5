...
class AnnotatedMixinElementHandlerShadow extends AnnotatedMixinElementHandler
{
    ...
    private void registerShadowForTarget(final AnnotatedElementShadow<?, ?> elem, final TypeHandle target) {
        final ObfuscationData<? extends IMapping<?>> obfData = (ObfuscationData<? extends IMapping<?>>)elem.getObfuscationData(this.obf.getDataProvider(), target.getName());
        if (obfData.isEmpty()) {
    ...
    abstract static class AnnotatedElementShadow<E extends Element, M extends IMapping<M>> extends AnnotatedMixinElementHandler.AnnotatedElement<E>
    {
        ...
        public ObfuscationData<M> getObfuscationData(final IObfuscationDataProvider provider, final String owner) {
        ...
        public abstract M getMapping(final String p0, final String p1, final String p2);
    ...
    class AnnotatedElementShadowField extends AnnotatedElementShadow<VariableElement, MappingField>
    {
        ...
        @Override
        public MappingField getMapping(final String owner, final String name, final String desc) {
    ...
    class AnnotatedElementShadowMethod extends AnnotatedElementShadow<ExecutableElement, MappingMethod>
    {
        ...
        @Override
        public MappingMethod getMapping(final String owner, final String name, final String desc) {
