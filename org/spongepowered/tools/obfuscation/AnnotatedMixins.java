...
class AnnotatedMixins implements IMixinAnnotationProcessor, ITokenProvider, ITypeHandleProvider, IJavadocProvider
{
    ...
    private void initTokenCache(final String tokens) {
        if (tokens != null) {
            ...
            final String[] arr$;
            final String[] tokenValues = arr$ = tokens.replaceAll("\\s", "").toUpperCase().split("[;,]");
            for (final String tokenValue : arr$) {
    ...
    public void registerAccessor(final TypeElement mixinType, final ExecutableElement method) {
        ...
        mixinClass.registerAccessor(method, AnnotationHandle.of(method, (Class<? extends Annotation>)Accessor.class));
    }
    ...
    public void registerInvoker(final TypeElement mixinType, final ExecutableElement method) {
        ...
        mixinClass.registerInvoker(method, AnnotationHandle.of(method, (Class<? extends Annotation>)Invoker.class));
    }
    ...
    public void registerOverwrite(final TypeElement mixinType, final ExecutableElement method) {
        ...
        mixinClass.registerOverwrite(method, AnnotationHandle.of(method, (Class<? extends Annotation>)Overwrite.class));
    }
    ...
    public void onPassCompleted() {
        ...
        for (final AnnotatedMixin mixin : this.mixinsForPass) {
            mixin.runValidators(IMixinValidator.ValidationPass.LATE, (Collection)this.validators);
        }
    }
