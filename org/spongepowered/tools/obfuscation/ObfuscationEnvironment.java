...
public abstract class ObfuscationEnvironment implements IObfuscationEnvironment
{
    ...
    public MappingMethod getObfMethod(final MappingMethod method, final boolean lazyRemap) {
        ...
        final MappingMethod originalMethod = method.copy();
        ...
        final String remappedOwner = this.getObfClass(methodMapping.getOwner());
        ...
        final String desc = ObfuscationUtil.mapDescriptor(methodMapping.getDesc(), (ObfuscationUtil.IClassRemapper)this.remapper);
    ...
    public MappingField getObfField(final MappingField field, final boolean lazyRemap) {
        ...
        final String remappedOwner = this.getObfClass(fieldMapping.getOwner());
