...
public class TypeHandle
{
    ...
    public MethodHandle findMethod(final String name, final String signature, final boolean matchCase) {
        ...
        return findMethod(this.getTargetElement(), name, signature, rawSignature, matchCase);
    }
    
    protected static MethodHandle findMethod(final TypeElement target, final String name, final String signature, final String rawSignature, final boolean matchCase) {
        for (final ExecutableElement method : getEnclosedElements(target, ElementKind.CONSTRUCTOR, ElementKind.METHOD)) {
