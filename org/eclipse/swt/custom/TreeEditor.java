...
public class TreeEditor extends ControlEditor
{
    ...
    public TreeEditor(final Tree tree) {
        ...
        this.column = 0;
        this.tree = tree;
        this.columnListener = (ControlListener)new lIlIlI(this);
        this.timer = this::layout;
        tree.addTreeListener(this.treeListener = (TreeListener)new lIllll(this));
    ...
    Rectangle computeBounds() {
        ...
        rectangle6.width -= rect.width;
        final Rectangle area = this.tree.getClientArea();
    ...
    public void dispose() {
        if (this.tree != null && !this.tree.isDisposed()) {
            if (this.column > -1 && this.column < this.tree.getColumnCount()) {
                final TreeColumn treeColumn = this.tree.getColumn(this.column);
