...
public class ConfigurableEmitter implements ParticleEmitter
{
    ...
    public ConfigurableEmitter(final String name) {
        this.spawnInterval = new Range(100.0f, 100.0f, (lII)null);
        this.spawnCount = new Range(5.0f, 5.0f, (lII)null);
        this.initialLife = new Range(1000.0f, 1000.0f, (lII)null);
        this.initialSize = new Range(10.0f, 10.0f, (lII)null);
        this.xOffset = new Range(0.0f, 0.0f, (lII)null);
        this.yOffset = new Range(0.0f, 0.0f, (lII)null);
        this.spread = new RandomValue(360.0f, (lII)null);
        this.angularOffset = new SimpleValue(0.0f, (lII)null);
        this.initialDistance = new Range(0.0f, 0.0f, (lII)null);
        this.speed = new Range(50.0f, 50.0f, (lII)null);
        this.growthFactor = new SimpleValue(0.0f, (lII)null);
        this.gravityFactor = new SimpleValue(0.0f, (lII)null);
        this.windFactor = new SimpleValue(0.0f, (lII)null);
        this.length = new Range(1000.0f, 1000.0f, (lII)null);
        this.colors = new ArrayList();
        this.startAlpha = new SimpleValue(255.0f, (lII)null);
        this.endAlpha = new SimpleValue(0.0f, (lII)null);
        this.emitCount = new Range(1000.0f, 1000.0f, (lII)null);
        this.usePoints = 1;
