...
public class ParticleTest extends BasicGame
{
    ...
    public void init(final GameContainer container) throws SlickException {
        ...
        (this.system = new ParticleSystem(image)).addEmitter((ParticleEmitter)new FireEmitter(400, 300, 45.0f));
    ...
    public static void main(final String[] argv) {
        try {
            final AppGameContainer container = new AppGameContainer((Game)new ParticleTest());
