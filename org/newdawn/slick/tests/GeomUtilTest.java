...
public class GeomUtilTest extends BasicGame implements GeomUtilListener
{
    ...
    public void init() {
        ...
        (this.cut = (Shape)this.circle).setLocation(203.0f, 78.0f);
    ...
    public void init(final GameContainer container) throws SlickException {
        this.util.setListener((GeomUtilListener)this);
        this.init();
    ...
    public static void main(final String[] argv) {
        try {
            final AppGameContainer container = new AppGameContainer((Game)new GeomUtilTest());
