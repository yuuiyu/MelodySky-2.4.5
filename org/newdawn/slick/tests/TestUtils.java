...
public class TestUtils
{
    ...
    public void init() {
        ...
        this.font = (Font)new TrueTypeFont(awtFont, false);
        try {
            this.texture = TextureLoader.getTexture("PNG", (InputStream)new FileInputStream("testdata/rocks.png"));
        ...
        try {
            this.oggEffect = AudioLoader.getAudio("OGG", (InputStream)new FileInputStream("testdata/restart.ogg"));
            ...
            this.aifEffect = AudioLoader.getAudio("AIF", (InputStream)new FileInputStream("testdata/burp.aif"));
            this.wavEffect = AudioLoader.getAudio("WAV", (InputStream)new FileInputStream("testdata/cbrown01.wav"));
        }
        catch (IOException e) {
            e.printStackTrace();
        }
