...
public class FontPerformanceTest extends BasicGame
{
    ...
    public void render(final GameContainer container, final Graphics g) {
        ...
        if (this.visible) {
            for (int i = 0; i < this.lines.size(); ++i) {
                this.font.drawString(10.0f, (float)(50 + i * 20), (String)this.lines.get(i), (i > 10) ? Color.red : Color.green);
            }
        }
    }
    ...
    public static void main(final String[] argv) {
        try {
            final AppGameContainer container = new AppGameContainer((Game)new FontPerformanceTest());
