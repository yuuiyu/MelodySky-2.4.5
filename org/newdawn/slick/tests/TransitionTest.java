...
public class TransitionTest extends StateBasedGame
{
    ...
    public void initStatesList(final GameContainer container) throws SlickException {
        this.addState((GameState)new ImageState(0, "testdata/wallpaper/paper1.png", 1));
        this.addState((GameState)new ImageState(1, "testdata/wallpaper/paper2.png", 2));
        this.addState((GameState)new ImageState(2, "testdata/bigimage.tga", 0));
    }
    ...
    public static void main(final String[] argv) {
        try {
            final AppGameContainer container = new AppGameContainer((Game)new TransitionTest());
